...
function applyDeclarativeNodeOptionParameters(nodeType) {
    ...
    if (existingRequestOptionsIndex !== -1) {
        ...
        const options = (_b = parameters[existingRequestOptionsIndex]) === null || _b === void 0 ? void 0 : _b.options;
        if (options) {
            options.sort((a, b) => {
...
function getNodeHints(workflow, node, nodeTypeData, nodeInputData) {
    var _a;
    const hints = [];
    if ((_a = nodeTypeData === null || nodeTypeData === void 0 ? void 0 : nodeTypeData.hints) === null || _a === void 0 ? void 0 : _a.length) {
            ...
            if (hint.displayCondition) {
                try {
                    ...
                    if (nodeInputData === undefined) {
                        ...
                        display = workflow.expression.getParameterValue(hint.displayCondition, runExecutionData !== null && runExecutionData !== void 0 ? runExecutionData : null, runIndex, 0, node.name, connectionInputData, 'manual', {});
                    }
