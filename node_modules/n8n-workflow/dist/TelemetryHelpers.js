...
function generateNodesGraph(workflow, nodeTypes, options) {
    ...
    otherNodes.forEach((node, index) => {
        ...
        if ((options === null || options === void 0 ? void 0 : options.isCloudDeployment) === true) {
            ...
            if (node.type === Constants_1.MERGE_NODE_TYPE && ((_13 = node.parameters) === null || _13 === void 0 ? void 0 : _13.operation) === 'combineBySql') {
                nodeItem.sql = (_14 = node.parameters) === null || _14 === void 0 ? void 0 : _14.query;
            }
        }
